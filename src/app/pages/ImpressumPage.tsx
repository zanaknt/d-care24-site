        ...
        >
          <div className="max-w-4xl mx-auto bg-white rounded-3xl border border-stone-200 shadow-md p-6 md:p-10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-2xl md:text-3xl text-[#183028]">Impressum</h1>
            </div>

            <div className="space-y-4 text-stone-600 text-sm md:text-base">
              <div>
                <h3 className="text-stone-800 font-semibold mb-2">Company Information</h3>
                <p>D-Care24+ GmbH</p>
                <p>Legal Form: Limited Liability Company (GmbH)</p>
              </div>

              <div>
                <h3 className="text-stone-800 font-semibold mb-2">Address</h3>
              ...
              <div>
                <h3 className="text-stone-800 font-semibold mb-2">Contact</h3>
                <p>
                  Email:{' '}
              ...
              <div>
                <h3 className="text-stone-800 font-semibold mb-2">Company Register</h3>
              ...
              <div>
                <h3 className="text-stone-800 font-semibold mb-2">Management</h3>
                <p>Managing Director: [Name]</p>
              </div>

              <div>
                <h3 className="text-stone-800 font-semibold mb-2">Professional Association</h3>
              ...
              <div>
                <h3 className="text-stone-800 font-semibold mb-2">Responsible for Content</h3>
