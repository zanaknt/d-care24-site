...
export const TermsPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-stone-800 pt-24 pb-16">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="max-w-4xl mx-auto bg-white rounded-3xl border border-stone-200 shadow-md p-6 md:p-10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-2xl md:text-3xl text-[#183028]">AGB</h1>
            </div>

            <div className="space-y-6 text-stone-600 text-sm md:text-base">
              <div>
                <h3 className="text-stone-800 font-semibold mb-2">1. Scope of Services</h3>
              ...
              <div>
                <h3 className="text-stone-800 font-semibold mb-2">2. Contract Formation</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-stone-800 font-semibold mb-2">3. Pricing and Payment</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-stone-800 font-semibold mb-2">4. Service Quality</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-stone-800 font-semibold mb-2">5. Cancellation Policy</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-stone-800 font-semibold mb-2">6. Replacement Caregivers</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-stone-800 font-semibold mb-2">7. Liability</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-stone-800 font-semibold mb-2">8. Data Protection</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-stone-800 font-semibold mb-2">9. Applicable Law</h3>
                <p className="leading-relaxed">
